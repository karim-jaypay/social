...
export const SliderData = [
    {
        image: instagramdot,
        info: ['Info on the most important economic events', 
        'Live market news, shared as stories', 
        'Trading Q&A show every Wednesday on IG Live', 
    ...
    {
        image: linkedindot,
        info: ['2 Hot 2 Not - Bi-monthly articles on what instruments are hot or not', 
        'Great weekly market update articles', 
    ...
    {
        image: youtubedot,
        info: ['How-To Guides on MT4 - From complete novice to pro video series', 
